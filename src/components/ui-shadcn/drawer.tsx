...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={`fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border bg-white dark:bg-slate-900 ${className || ''}`}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Description ref={ref} className={`text-sm text-gray-500 dark:text-slate-400 ${className || ''}`} {...props} />
))
